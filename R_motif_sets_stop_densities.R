...
int3_plot <- density_histogram(data, xlab = "SCD", ylab = "Count", binwidth = 0.01, title = "INT3")
...
data = read.csv(filepath, head = T)
rescue_plot <- density_histogram(data, xlab = "SCD", ylab = "Count", binwidth = 0.008, title = "RESCUE")
...
data = read.csv(filepath, head = T)
ke400_plot <- density_histogram(data, xlab = "SCD", ylab = "Count", binwidth = 0.003, title = "Ke400")
...
data = read.csv(filepath, head = T)
pese_plot <- density_histogram(data, xlab = "SCD", ylab = "Count", binwidth = 0.001, title = "PESE")
...
data = read.csv(filepath, head = T)
esr_plot <- density_histogram(data, xlab = "SCD", ylab = "Count", binwidth = 0.005, title = "ESR")
...
data = read.csv(filepath, head = T)
ise_plot = density_histogram(data, xlab = "SCD", ylab = "Count", binwidth = 0.0075, title = "ISE")
...
data = read.csv(filepath, head = T)
iss_plot = density_histogram(data, xlab = "SCD", ylab = "Count", binwidth = 0.0075, title = "ISS")
...
data = read.csv(filepath, head = T)
fas_hex2_plot = density_histogram(data, xlab = "SCD", ylab = "Count", binwidth = 0.01, title = "FAS-hex2 ESS")
...
data = read.csv(filepath, head = T)
fas_hex3_plot = density_histogram(data, xlab = "SCD", ylab = "Count", binwidth = 0.005, title = "FAS-hex3 ESS")
...
data = read.csv(filepath, head = T)
rbp_cds_plot = density_histogram(data, xlab = "SCD", ylab = "Count", binwidth = 0.005, title = "RBPs (CDS-binding)")
