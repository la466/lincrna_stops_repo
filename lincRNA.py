...
import lincRNA_misc_ops as lmisco
...
def main():
    ...
    # extract second set
    if extract_second:
        local_output_dir = "{0}/genome_sequences/lincrna/{1}".format(output_directory, output_prefix)
        lmisco.extract_second_seqs(input_bed, input_file, input_fasta, local_output_dir)
